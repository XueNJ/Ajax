		...
		<div class="container-fluid">
			<div id="divBrand" class="mr-3">
				<img src="imgs/logo.gif" width="30" height="30" class=" mr-3"
					...
					title="販賣機購物系統">販賣機購物系統</a> <span><font
					style="font-size: 14px; color: orange;">[${sessionScope.account.name}
						先生/小姐!您好。]</font></span>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<%-- <form class="form-inline my-2 my-lg-0" id="frmSearch"
					name="frmSearch" method="post" autocomplete="off">
					<input class="form-control mr-sm-2" type="search"
						id="searchKeyword" name="searchKeyword" placeholder="Search"
						aria-label="輸入關鍵字或品號..."> <span><button
							class="btn btn-outline-success" type="button"
							onclick="ViewListAction(document.forms.frmSearch);">搜尋</button> </span>
					&nbsp;
				</form>--%>
				<span class="">
					<button class="btn btn-outline-info" type="button"
						onclick="doQueryCartGoods();">查詢購物車</button>
					<button class="btn btn-outline-secondary" type="button"
						onclick="doClearCartGoods();">清除購物車</button>
